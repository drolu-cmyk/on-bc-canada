...
The source-only status remains active until a configured environment supplies an approved bucket name, AWS account, deployment role, domain decision, monitoring route, and human authorization. No learner data enters the public artifact.
